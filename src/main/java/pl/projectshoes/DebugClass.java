...
public class DebugClass implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        if(productRepository.findAll().isEmpty()){
            productRepository.save(new Product(Category.KIDS, Brand.ADIDAS,"XP", Color.BLACK,new Size(30.5,Standard.CM),2,"xd",1,"xddd","img.url",true,true,true,true,true,LocalDateTime.now()));
        }
