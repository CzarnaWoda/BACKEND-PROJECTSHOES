    ...
    SecurityFilterChain securityFilterChain(HttpSecurity security) throws Exception{
        ...
        security.authorizeHttpRequests(
                        auth -> auth.requestMatchers(HttpMethod.POST, "/api/v1/user/register").permitAll()
                                ...
                                .requestMatchers(new AntPathRequestMatcher("/api/v1/products/create")).permitAll()
                                .requestMatchers(HttpMethod.GET, "/api/v1/products/all").permitAll()
                                .requestMatchers(HttpMethod.GET, "/api/v1/products/{productCode}").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/api/v1/products/delete/{productCode}").permitAll()
                                .requestMatchers(HttpMethod.GET, "/api/v1/user/details").authenticated()
                                .requestMatchers(HttpMethod.GET, "/api/v1/user/validate").authenticated()
                                .requestMatchers(HttpMethod.GET, "/api/v1/user/userDetails").authenticated()
                                .requestMatchers(HttpMethod.POST,"/api/v1/user/changePassword").authenticated()
                                .requestMatchers(HttpMethod.GET, "/api/v1/user/admin").authenticated()
